...
ISO27001_CONTROLS: list[dict[str, str]] = [
    ...
    {"id": "A.5.22", "name": "Monitoring, Review and Change Mgmt of Supplier Services",
     "category": "organizational"},
    {"id": "A.5.23", "name": "Information Security for Use of Cloud Services",   "category": "organizational"},
    {"id": "A.5.24", "name": "Info Security Incident Mgmt Planning and Preparation",
     "category": "organizational"},
    ...
    {"id": "A.8.31", "name": "Separation of Dev, Test and Production Environments",
